...
<body style="background:#f0f9fd;">
    ...
    <span><img src="images/leftico01.png" /></span>小米功能
        ...
        <li><cite></cite><a href="${basePath}user?method=findUserByPage" target="rightFrame">用户管理</a><i></i></li>
        <li><cite></cite><a href="${basePath}category?method=findCategoryByPage" target="rightFrame">商品类别管理</a><i></i></li>
        <li><cite></cite><a href="${basePath}goods?method=findGoodsByPage" target="rightFrame">商品管理</a><i></i></li>
